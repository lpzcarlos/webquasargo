      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center md:items-start gap-12">
        ...
        <div className="flex gap-12 font-sans text-sm text-center md:text-left">
          <div className="flex flex-col gap-3">
            ...
            <a href="#" className="text-[#E4ECFF]/60 hover:text-primary transition-colors">Términos y Condiciones</a>
            <a href="#" className="text-[#E4ECFF]/60 hover:text-primary transition-colors">Política de Privacidad</a>
          </div>
        </div>
      </div>
